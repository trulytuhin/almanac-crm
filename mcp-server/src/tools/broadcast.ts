...
//
// Registered only when BOTH ALMANAC_ENABLE_WRITES and
// ALMANAC_ENABLE_BROADCASTS are set. A single call can message up to
...
export function registerBroadcastTools(server: McpServer, client: AlmanacClient): void {
  server.registerTool(
    'send_broadcast',
    {
