...
import { AlmanacMark } from '@/components/brand/almanac-mark';
...
const navItems: NavItem[] = [
  ...
  { href: '/lead-sources', labelKey: 'leadSources', icon: UserPlus },
        ...
        <div className="border-border flex h-14 shrink-0 items-center justify-between gap-2 border-b px-4">
          <Link href="/dashboard" className="flex items-center gap-2">
            <div className="bg-primary text-primary-foreground flex h-8 w-8 items-center justify-center rounded-lg">
              <AlmanacMark className="h-[18px] w-[18px]" />
            </div>
            <span className="font-brand text-foreground text-[17px] font-semibold">
              {t('title')}
            </span>
          </Link>
          <button
