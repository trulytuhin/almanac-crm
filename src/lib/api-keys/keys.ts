...
//
// Why the `almanac_live_` prefix
//   - Self-identifying: a leaked string is instantly recognisable as
//     an Almanac key (handy for secret-scanners like GitGuardian).
//   - Forward-compatible: leaves room for an `almanac_test_` variant if
...
export const API_KEY_PREFIX = 'almanac_live_';
