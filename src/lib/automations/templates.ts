...
export const AUTOMATION_TEMPLATES: Record<TemplateSlug, AutomationTemplateDefinition> = {
  ...
  out_of_office: {
    ...
    steps: [
      ...
      },
      {
        ...
        step_config: {
          text:
            "Thanks for your message! We're closed right now (open 9am–6pm) and will reply first thing tomorrow.",
        },
        parent_index: 0,
        branch: 'yes',
      },
  ...
  lead_qualifier: {
    ...
    trigger_config: {
      // "rate" and "kitna" (Hindi for "how much") are how a lot of
      // customers in India ask for a price on WhatsApp.
      keywords: ['price', 'pricing', 'rate', 'kitna', 'quote', 'buy'],
      match_type: 'contains',
    },
    steps: [
      {
        ...
        step_config: {
          text:
            "Happy to help with pricing! Which product are you looking at, and how many do you need?",
        },
      },
      {
        step_type: 'wait',
