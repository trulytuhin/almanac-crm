...
export const STORAGE_KEY = "almanac.theme";
 ...
 * at runtime via `document.documentElement.dataset.mode`. Almanac
 * defaults to light (paper and ink); dark is the opt-in alternative.
 *
 * Persisted under its own localStorage key so it composes freely
 * with the accent choice (you can run Almanac-light or Almanac-dark).
 */
...
export const MODE_STORAGE_KEY = "almanac.mode";
...
export const THEMES: ReadonlyArray<ThemeMeta> = [
  {
    id: "almanac",
    name: "Almanac",
    tagline: "The default. Deep green on paper, like a well-kept ledger.",
    swatch: "#0a5030",
  },
  {
    id: "violet",
