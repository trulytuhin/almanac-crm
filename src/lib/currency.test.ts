...
describe("formatCurrency", () => {
  ...
  it("groups rupees the Indian way", () => {
    expect(formatCurrency(123_456, "INR")).toContain("1,23,456");
  });
...
describe("formatCurrencyShort", () => {
  ...
  it("counts rupees in lakh and crore", () => {
    expect(formatCurrencyShort(250_000, "INR")).toBe("₹2.5L");
    expect(formatCurrencyShort(12_000_000, "INR")).toBe("₹1.2Cr");
    expect(formatCurrencyShort(99_000, "INR")).toBe("₹99.0k");
  });
