...
// Seed stages for a new pipeline, shaped around how a small business
// sells over WhatsApp: an enquiry comes in, you send a price, you wait
// on payment. Rename or reorder them from the pipeline settings.
const SPEC_DEFAULT_STAGES = [
  { name: "New enquiry", color: "#3b82f6", position: 0 }, // blue
  { name: "Interested", color: "#eab308", position: 1 }, // yellow
  { name: "Quote sent", color: "#f97316", position: 2 }, // orange
  { name: "Payment pending", color: "#8b5cf6", position: 3 }, // purple
