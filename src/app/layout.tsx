...
// Wordmark and display type only; see `.font-brand` in almanac.css.
const aleo = Aleo({
  variable: "--font-brand",
  subsets: ["latin"],
  weight: ["500", "600"],
...
export const metadata: Metadata = {
  ...
  description:
    "Almanac is a self-hostable WhatsApp CRM for small businesses and one-person companies.",
  robots: {
    index: false,
    follow: false,
  },
...
export default async function RootLayout({
  ...
  return (
    <html
      ...
      className={`${hostGrotesk.variable} ${aleo.variable} h-full antialiased`}
